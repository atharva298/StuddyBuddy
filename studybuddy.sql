...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 08, 2024 at 06:44 PM
...
(12, 4, 'Venkatesh', 'Regarding class on coming Wednesday', 'There will be an extra class on coming Monday from 5 to 7 pm.');
...
(4, 'IIT2021082', 'SE', 4, 'What is design?', 'WhY?');
...
('ADMIN001', 'Abdullah', 'A', 'ADMIN001', 'admin001@iiita.ac.in'),
('PROIT001', 'Venkatesh', 'P', 'PROIT001', 'proit001@iiita.ac.in'),
('PROIT002', 'Aman Kumar', 'T', 'PROIT002', 'proit002@iiita.ac.in'),
('TATIT001', 'Junaid', 'T', 'TATIT001', 'tatit001@iiita.ac.in');
...
(40, 'IIT2021170', 'IIT2021170', 'Hello'),
(41, 'IIT2021082', 'IIT2021170', 'hello'),
(42, 'IIT2021082', 'IIT2021170', 'heyya'),
(43, 'IIT2021082', 'IIT2021170', 'wdw'),
(44, 'IIT2021082', 'IIT2021170', 'Hello'),
(45, 'IIT2021082', 'IIT2021170', 'dd');
...
('1_10', 10, 1, 'IIT2021168', 'Kaushik Mullick', 'Helllo', NULL, NULL),
('1_11', 11, 1, 'PROIT001', 'Venkatesh', 'hello', NULL, 'PROIT001'),
('1_12', 12, 1, 'IIT2021168', 'Kaushik Mullick', 'HEEHEE', NULL, NULL),
('1_13', 13, 1, 'IIT2021168', 'Kaushik Mullick', '<script> alert(\"Watch your steps, you know there is no returning back\") </script> HEEHEE', NULL, NULL),
('1_2', 2, 1, 'IIT2021168', 'Kaushik', '3nf is another form of decomposition', NULL, NULL),
('1_3', 3, 1, 'TATIT001', 'Junaid', '3nf is something', 'TATIT001', NULL),
('1_4', 4, 1, 'IIT2021168', 'Kaushik', 'tthis is tje aanswer', NULL, 'PROIT001'),
('1_5', 5, 1, 'TATIT001', 'Junaid', 'Above all answers are correct', 'TATIT001', NULL),
('1_6', 6, 1, 'PROIT001', 'Venkatesh', 'Heyy!!', NULL, NULL),
('1_7', 7, 1, 'PROIT001', 'Venkatesh', '3NF is very good', NULL, NULL),
('1_8', 8, 1, 'IIT2021170', 'Viraj Jagtap', 'Bharat Mata Ki Jay!!', NULL, NULL),
('1_9', 9, 1, 'PROIT001', 'Venkatesh', 'Lalala', NULL, 'PROIT001'),
('2_1', 1, 2, 'PROIT001', 'Venkatesh', 'this is the answer', NULL, 'PROIT001'),
...
('4_1', 1, 4, 'IIT2021082', 'Indrajeet', 'Design is me.', NULL, 'PROIT001');
...
('IIT2021047', 'Akshay', 4, 'IIT2021047', 'iit2021047@iiita.ac.in'),
('IIT2021082', 'Indrajeet', 4, 'IIT2021082', 'iit2021082@iiita.ac.in'),
('IIT2021125', 'Radhika', 3, 'IIT2021125', 'iit2021125@iiita.ac.in'),
('IIT2021168', 'Kaushik Mullick', 4, 'IIT2021168', 'iit2021168@iiita.ac.in'),
('IIT2021170', 'Viraj Jagtap', 4, 'IIT2021170', 'IIT2021170@iiita.ac.in'),
